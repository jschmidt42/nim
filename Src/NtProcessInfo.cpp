...
static pfnNtQueryInformationProcess gNtQueryInformationProcess;
...
{
	assert( sizeof(smPROCESS_BASIC_INFORMATION) == sizeof(PROCESS_BASIC_INFORMATION) );
	assert( sizeof(smRTL_USER_PROCESS_PARAMETERS) == sizeof(RTL_USER_PROCESS_PARAMETERS) );
